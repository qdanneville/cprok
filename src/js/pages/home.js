                            ...
                            modsCollection.map((item, i) => {
                                return (
                                    <li className="mx-6 flex-grow-1 w-33-per text-align-center flex justify-center flex-col items-center text-white" key={item.id}>
                                        <div onClick={() => start_game(item.id)} className="bg-dark py-4 px-4 br-10 w-full flex justify-center flex-col items-center py-10 cursor-pointer shadow-1 hover:bg-white hover:text-dark transition hover:scale-11">
